# DeepSigma.Azure.Storage

Azure torage helpers: upload, download, delete, and list. Wraps `Azure.Storage.Blobs` for a single named container.
...
```bash
dotnet add package DeepSigma.Azure.Storage
```
